...
const NavItem: React.FC<NavItemProps> = ({ icon, label, isActive, isParent }) => {
  const textColor = isActive ? 'text-[#1579BE]' : 'text-[#606060]';
  
  return (
    <div className={`flex items-center gap-3 ${isParent ? '' : 'pl-4'}`}>
      <img
        src={icon}
  ...
  return (
    <div className="rounded shadow-[0px_0px_16px_0px_rgba(33,126,192,0.10)] flex mb-[-102px] items-stretch gap-3 text-[13px] text-[#1579BE] font-semibold bg-white mt-3 pr-2 py-[11px] max-md:mb-2.5">
      ...
      <div>
        ...
        <div className="mt-5">
          <NavItem icon="https://cdn.builder.io/api/v1/image/assets/TEMP/1449705c6102054ee9c93a144a2c20f88a6df4f6?placeholderIfAbsent=true" label="Dashboard" />
        </div>
        <div className="mt-5">
          <NavItem icon="https://cdn.builder.io/api/v1/image/assets/TEMP/175c38a16d77fc0b5e78fc196944ce44f386857b?placeholderIfAbsent=true" label="Video Feed" isActive />
        </div>
        <div className="mt-5">
          <NavItem icon="https://cdn.builder.io/api/v1/image/assets/TEMP/b9632abacf4b78b309f3d4040f09f8a8d28dd2f7?placeholderIfAbsent=true" label="Melting Line" />
        </div>
      </div>
    </div>
  );
